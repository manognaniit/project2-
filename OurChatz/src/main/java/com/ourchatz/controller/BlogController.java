...
public class BlogController {
	...
	@RequestMapping(value="/viewBlog/{postedBy}",headers="Accept=application/json",method=RequestMethod.GET)
	public List<Blog> viewBlogs (@PathVariable("postedBy")String postedBy){
		System.out.print("given name:"+postedBy);
	    return blogDao.viewBlogs(postedBy);
		}
